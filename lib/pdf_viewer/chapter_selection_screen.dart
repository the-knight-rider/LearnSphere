...
class _ChapterSelectionScreenState extends State<ChapterSelectionScreen> {
  final List<ChapterInfo> _chapters = [
    ChapterInfo(
      ...
      assetPath: 'assets/physics_chapter1.pdf',
    ),
    ChapterInfo(
      number: 2,
      title: 'Electrostatic Potential and Capacitance',
      assetPath: 'assets/physics_chapter2.pdf',
    ),
    ChapterInfo(
      number: 3,
      title: 'Current Electricity',
      assetPath: 'assets/physics_chapter3.pdf',
    ),
    ChapterInfo(
      number: 4,
      title: 'Moving Charges and Magnetism',
      assetPath: 'assets/physics_chapter4.pdf',
    ),
    ChapterInfo(
      number: 5,
      title: 'Magnetism and Matter',
      assetPath: 'assets/physics_chapter5.pdf',
    ),
    ChapterInfo(
      number: 6,
      title: 'Electromagnetic Induction',
      assetPath: 'assets/physics_chapter6.pdf',
    ),
    ChapterInfo(
      number: 7,
      title: 'Alternating Current',
      assetPath: 'assets/physics_chapter7.pdf',
    ),
    ChapterInfo(
      number: 8,
      title: 'Electromagnetic Waves',
      assetPath: 'assets/physics_chapter8.pdf',
    ),
    ChapterInfo(
      number: 9,
      title: 'Ray Optics and Optical Instruments',
      assetPath: 'assets/physics_chapter9.pdf',
    ),
    ChapterInfo(
      number: 10,
      title: 'Wave Optics',
      assetPath: 'assets/physics_chapter10.pdf',
    ),
    ChapterInfo(
      number: 11,
      title: 'Dual Nature of Radiation and Matter',
      assetPath: 'assets/physics_chapter11.pdf',
    ),
    ChapterInfo(
      number: 12,
      title: 'Atoms',
      assetPath: 'assets/physics_chapter12.pdf',
    ),
    ChapterInfo(
      number: 13,
      title: 'Nuclei',
      assetPath: 'assets/physics_chapter13.pdf',
    ),
    ChapterInfo(
      number: 14,
      title:
          'Semiconductor Electronics: Materials, Devices and Simple Circuits',
      assetPath: 'assets/physics_chapter14.pdf',
    ),
  ];
