...
class ChemistryChapterSelectionScreen extends StatefulWidget {
  const ChemistryChapterSelectionScreen({super.key});

  @override
  State<ChemistryChapterSelectionScreen> createState() =>
      _ChemistryChapterSelectionScreenState();
}

class _ChemistryChapterSelectionScreenState
    extends State<ChemistryChapterSelectionScreen> {
  final List<ChapterInfo> _chapters = [
    ChapterInfo(
      number: 1,
      title: 'Some Basic Concepts of Chemistry',
      assetPath: 'assets/chemestry/chemestry_chapter1.pdf',
    ),
    ChapterInfo(
      number: 2,
      title: 'Structure of Atom',
      assetPath: 'assets/chemestry/chemestry_chapter2.pdf',
    ),
    ChapterInfo(
      number: 3,
      title: 'Classification of Elements',
      assetPath: 'assets/chemestry/chemestry_chapter3.pdf',
    ),
    ChapterInfo(
      number: 4,
      title: 'Chemical Bonding and Molecular Structure',
      assetPath: 'assets/chemestry/chemestry_chapter4.pdf',
    ),
    ChapterInfo(
      number: 5,
      title: 'States of Matter',
      assetPath: 'assets/chemestry/chemestry_chapter5.pdf',
    ),
    ChapterInfo(
      number: 6,
      title: 'Thermodynamics',
      assetPath: 'assets/chemestry/chemestry_chapter6.pdf',
    ),
    ChapterInfo(
      number: 7,
      title: 'Equilibrium',
      assetPath: 'assets/chemestry/chemestry_chapter7.pdf',
    ),
    ChapterInfo(
      number: 8,
      title: 'Redox Reactions',
      assetPath: 'assets/chemestry/chemestry_chapter8.pdf',
    ),
    ChapterInfo(
      number: 9,
      title: 'Hydrogen',
      assetPath: 'assets/chemestry/chemestry_chapter9.pdf',
    ),
    ChapterInfo(
      number: 10,
      title: 'The s-Block Elements',
      assetPath: 'assets/chemestry/chemestry_chapter10.pdf',
    ),
  ];
  ...
  Widget _buildRecentlyReadSection() {
    ...
    // Find the most recently read chemistry chapter
    String? mostRecentPath;
    DateTime mostRecentTime = DateTime(2000);

    _readingHistory.forEach((path, data) {
      // Only consider chemistry chapters
      if (path.contains('chemestry')) {
